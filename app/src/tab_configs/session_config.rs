...
use super::tab_config::{
    generated_worktree_path_string, TabConfigParam, TabConfigParamType,
    AUTOGENERATED_BRANCH_NAME_PARAM,
};
use super::tab_config::{TabConfig, TabConfigPaneNode, TabConfigPaneType};
...
pub fn build_tab_config(
    ...
    #[cfg(feature = "oss_release")]
    let _ = autogenerate_worktree_branch_name;
