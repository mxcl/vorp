...
pub mod client {
    ...
    pub use super::ManagedSecretValue;
...
pub struct ManagedSecret {
    ...
    pub created_at: crate::server::timestamp::ServerTimestamp,
    pub updated_at: crate::server::timestamp::ServerTimestamp,
...
pub struct ManagedSecretOwner {
    pub uid: String,
    pub type_: ManagedSecretOwnerType,
}

#[derive(Clone, Copy, Debug)]
pub enum ManagedSecretOwnerType {
    Team,
    User,
}
